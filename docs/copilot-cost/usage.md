...
| Conversation total | Best-known current conversation total: local assistant/compaction usage stays pending until the extension captures Copilot's official session counter. |
