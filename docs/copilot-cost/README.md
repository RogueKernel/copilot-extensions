# copilot-cost documentation

`copilot-cost` shows Copilot CLI message cost, conversation cost, cumulative Copilot session total, context usage, cache health, and rolling usage windows while you work.
